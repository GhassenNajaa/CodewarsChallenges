...
You need to balance things up. Add '1' to the end of the md5 addresses as many times as you need to make them the same length as those in the sha256 column.
...
CONCAT(REPEAT('0',LENGTH(sha256)-LENGTH(sha1)),sha1) AS sha1,sha256 FROM encryption;
